...
$contrasena=$_GET['pass'];
	$sql="insert into persona(nombre,apellido,correo,password) values ('$nombres','$apellidos','$correo','$contrasena')";
...
echo "<tr class='bg2 ' align='center'><td>".$fila['nombre']."</td><td>".$fila['apellido']."</td> <td>".$fila['correo']."</td></tr>";
				}		
echo "</table>";
?> 	 
